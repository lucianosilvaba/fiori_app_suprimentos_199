		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gerenciamento de Suprimentos",
									"targetURL": "#brcomsuprifioriappsuprimentos199-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomsuprifioriappsuprimentos199-display": {
								"semanticObject": "brcomsuprifioriappsuprimentos199",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.supri.fioriappsuprimentos199",
									"url": sap.ui.require.toUrl("br/com/supri/fioriappsuprimentos199")
								}
							}
						}
					}
